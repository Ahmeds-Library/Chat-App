...
export const MessageList: React.FC<MessageListProps> = ({
  ...
  const scrollToBottom = React.useCallback(() => {
    if (messagesEndRef.current) {
      ...
      if (container) {
        ...
        // Method 2: Smooth GSAP animation for better UX
        gsap.to(container, {
        ...
        // Method 3: Fallback - scroll into view
  ...
  useEffect(() => {
    if (!isLoading && messages.length > 0) {
      console.log('📜 MessageList: Messages loaded, scrolling to bottom');
  ...
  return (
    <div className="p-4" ref={messagesContainerRef}>
      <div className="space-y-4 min-h-full">
        ...
        {/* Enhanced scroll anchor with better positioning */}
        <div 
          ref={messagesEndRef} 
