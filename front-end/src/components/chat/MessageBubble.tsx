      ...
      >
        ...
        {isEditing ? (
          ...
          <div className="flex items-start gap-2">
            ...
            <p className="text-sm leading-relaxed break-words whitespace-pre-wrap flex-1">
              {message.content}
            </p>
            
            {/* Edit button positioned next to message content */}
            {isOwnMessage && !isEditing && onEdit && (
              <Button
                ...
                className={`
                  h-6 w-6 p-0 flex-shrink-0 ml-1
